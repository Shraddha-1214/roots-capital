...
function App() {
  ...
  return (
    <main className="w-full min-h-screen bg-[#F9F7F2] selection:bg-[#5E1214]/30">
      <Navbar 
        logoText="Roots Capital"
        onCtaClick={() => scrollTo('contact')}
      />
      {/* Note: TrustBar is removed because it is now built into Hero for better spacing */}
      <Hero />
      <Process />
      <Services />
      <About />
      ...
      <footer className="bg-slate-900 text-white pt-24 pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-16">
            ...
            <div>
              <h5 className="font-bold uppercase tracking-widest text-xs text-[#C5A059] mb-8">Contact</h5>
              <ul className="space-y-4 text-white/50 text-sm">
                <li>9022757060 / 8097807061 </li>
                <li>info@rootscapital.in</li>
                <li className="pt-4 text-white font-medium italic">"Connected to roots of every financial need."</li>
              </ul>
            </div>
          </div>
          <div className="pt-12 border-t border-white/5">
            <div className="flex flex-col md:flex-row justify-between gap-8">
              <div className="text-[10px] text-white/30 uppercase tracking-widest space-y-2">
                <p>Office No 1003, Millenium Empire, Sector - 15, Kharghar, Navi Mumbai - 410210</p>
